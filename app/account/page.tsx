    ...
    <ProtectedRoute>
      <div className="flex flex-col min-h-[100dvh]">
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 pb-8 flex justify-center">
          <Link href="/transfer" className="inline-flex items-center gap-2 rounded-full bg-white text-vault-ink px-6 py-3 text-[14px] font-medium min-h-[44px]">Next: Try sending →</Link>
        </div>
      </div>
        <HelpWidget />
