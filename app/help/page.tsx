    ...
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          <a href="/account" className="inline-flex items-center gap-2 rounded-full bg-vault-ink text-white px-6 py-3 text-[14px] font-medium min-h-[44px]">Back to your account →</a>
          <a href="/" className="inline-flex items-center gap-2 rounded-full border border-silver-veil px-6 py-3 text-[14px] min-h-[44px]">Back to home ↑</a>
        </div>
      </div>
      </div>
      <HelpWidget />
