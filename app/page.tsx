          ...
          <div className="max-w-[1280px] mx-auto space-y-8">
            ...
            <div className="grid md:grid-cols-[1.4fr_0.6fr] gap-6">
              ...
              <div className="rounded-[8px] bg-[#efefef] p-6 border border-[#aeaeae]/20">
                ...
                <Link href="/account" className="mt-6 inline-flex w-full justify-center rounded-[8px] border border-[#2a2a2a] bg-white text-[#0f111a] px-4 py-3 text-[14px] font-normal hover:border-[#0f111a]">View all activity →</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <Link href="/account#trusted-contact-manager" className="rounded-[8px] bg-[#141414] border border-[#2a2a2a] p-6 hover:border-[#aeaeae] transition text-left">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <Link href="/no-puzzles" className="rounded-[8px] bg-white p-6 flex flex-col gap-2 border border-[#2a2a2a] hover:border-[#0f111a] transition text-left">
